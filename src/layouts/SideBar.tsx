...
export const SideBar = () => {
    return (
        <>
            ...
            <aside className="w-56 lg:sticky absolute top-0 overflow-y-auto scrollbar-hidden pb-4 px-2 lg:flex flex-col gap-2 hidden">
                <LargeSidebarSection>
                    <LargeSidebarItem isActive IconOrImgUrl={Home} title="Home" url="/" />
                    <LargeSidebarItem IconOrImgUrl={Clapperboard} title="Subscriptions" url="/subscription" />
                </LargeSidebarSection>
                <hr />
